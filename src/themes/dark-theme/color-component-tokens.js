...
/* ---- Component colors ---- */
// TODO: Make it a plain object in the next major version
...
export default (
  ...
  buttonPrimarySelectedText: primitives.black,
  ...
  buttonSecondarySpinnerForeground: primitives.white,
  ...
  calendarForeground: primitives.white,
  ...
  // ProgressSteps
  progressStepsCompletedText: primitives.black,
  progressStepsCompletedFill: primitives.primary,
  progressStepsActiveText: primitives.black,
